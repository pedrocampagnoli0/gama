...
/**
 * Service Implementation for managing {@link com.myapp.domain.Aluno}.
 */
@Service
@Transactional
public class AlunoService {
    ...
    public AlunoService(AlunoRepository alunoRepository, AlunoMapper alunoMapper, MetaRepository metaRepository) {
