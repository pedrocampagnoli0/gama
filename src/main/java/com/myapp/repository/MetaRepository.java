...
import com.myapp.domain.enumeration.AreaDoEnem;
...
public interface MetaRepository extends JpaRepository<Meta, Long> {
    ...
    boolean existsByAlunoAndArea(@Param("aluno") Aluno aluno, @Param("area") AreaDoEnem area);

    boolean existsByAlunoAndAreaAndIdNot(@Param("aluno") Aluno aluno, @Param("area") AreaDoEnem area, Long id);
