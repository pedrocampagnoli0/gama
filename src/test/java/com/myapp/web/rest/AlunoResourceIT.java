...
import static com.myapp.domain.AlunoAsserts.*;
...
import com.myapp.repository.AlunoRepository;
import com.myapp.service.dto.AlunoDTO;
import com.myapp.service.mapper.AlunoMapper;
...
class AlunoResourceIT {
    ...
    public static Aluno createEntity() {
        return new Aluno().nome(DEFAULT_NOME).matricula(DEFAULT_MATRICULA);
    }
    ...
    public static Aluno createUpdatedEntity() {
        return new Aluno().nome(UPDATED_NOME).matricula(UPDATED_MATRICULA);
    }
    ...
    void putExistingAluno() throws Exception {
        ...
        updatedAluno.nome(UPDATED_NOME).matricula(UPDATED_MATRICULA);
    ...
    void partialUpdateAlunoWithPatch() throws Exception {
        ...
        partialUpdatedAluno.matricula(UPDATED_MATRICULA);
    ...
    void fullUpdateAlunoWithPatch() throws Exception {
        ...
        partialUpdatedAluno.nome(UPDATED_NOME).matricula(UPDATED_MATRICULA);
